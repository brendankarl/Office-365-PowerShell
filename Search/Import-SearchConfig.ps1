#Specify tenant admin, site URL and scope to import from
$User = ""
$SiteURL = ""
$Scope = "SPSite"
...
[xml]$SearchSchema = Get-Content $Schema 
$SearchConfig = $Search.ImportSearchConfiguration($Owner,$SearchSchema.OuterXml)
